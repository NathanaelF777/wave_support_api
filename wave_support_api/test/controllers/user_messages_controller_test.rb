...
class UserMessagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_message" do
    assert_difference('UserMessage.count') do
      post user_messages_url, params: { user_message: { body: @user_message.body, ticket_id: @user_message.ticket_id, title: @user_message.title, user_id: @user_message.user_id } }, as: :json
    end
  ...
  test "should update user_message" do
    patch user_message_url(@user_message), params: { user_message: { body: @user_message.body, ticket_id: @user_message.ticket_id, title: @user_message.title, user_id: @user_message.user_id } }, as: :json
    assert_response 200
  end
